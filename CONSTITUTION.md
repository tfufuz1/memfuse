...
Alle Tag-Typen (`AI-TAG`, `ANCHOR`, `REVIEW-PASS`, `FILE-CONTEXT`) und deren Pflichtgrammatik sind verbindlich in [`rules/tag_taxonomy.md`](rules/tag_taxonomy.md) definiert.
