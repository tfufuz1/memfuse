...
//!
//! This crate provides the execution environment for Agent tools and custom logic.
//! It utilizes WebAssembly (WASM) to provide a secure, isolated sandbox that prevents
//! unauthorized host access while allowing high-performance execution of compiled code.
