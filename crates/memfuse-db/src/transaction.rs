...
//! Transaction orchestration for MemFuse.
//!
//! This module provides the `DbTransaction` struct which coordinates
//! atomic commits across the LSM storage engine and the HNSW vector index.
