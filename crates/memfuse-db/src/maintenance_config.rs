// FILE-CONTEXT
// ZWECK: Konfiguration des PhysioSchedulers für konsolidierte Physiologie-Hintergrund-Tasks.
...
#[cfg(not(feature = "physio-percolation"))]
...
pub struct MaintenanceConfig {
    ...
    /// Thermostat-Konfiguration (κ, base_half_life_tx, eviction_threshold).
    #[serde(flatten)]
    ...
    // --- SleepCycle ---
    /// Ob SleepCycle-Konsolidierung aktiviert ist. Default: false (erfordert LLM).
    pub sleep_cycle_enabled: bool,
    /// Schwellenwert der Episoden für SleepCycle-Triggern. Default: 50.
