...
impl MemFuse {
    ...
    // AGENT:04 DATE:2026-05-21 STATUS:DONE
    ...
    pub async fn hybrid_search(
        ...
        self.default_col()
            .await?
            .hybrid_search_legacy(text, vector, k)
            .await
    }

    /// Performs unified 4-signal hybrid search.
    pub async fn hybrid_search_unified(
        &self,
        query: collection::HybridQuery,
    ) -> Result<Vec<SearchResult>> {
        self.default_col().await?.hybrid_search(query).await
    }
