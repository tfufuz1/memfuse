...
//!
// AGENT:08 DATE:2026-05-20 STATUS:DONE
//!
//! ## Quick Start
//!
//! ```rust,no_run
...
impl MemFuse {
    ...
    ///
    /// # Errors
    /// Returns an error if the collection name is invalid or too long.
    ...
    ///
    /// # Errors
    /// Returns an error if storage scan fails.
    ...
    ///
    /// # Errors
    /// Returns an error if the collection is the default collection or if deletion fails.
