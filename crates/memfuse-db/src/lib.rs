...
impl MemFuse {
    ...
    // ANCHOR:FIXME:DB-002 AGENT:04 STATUS:READY PRIO:1
    // Minimal intervention by AGENT:01 to restore buildability for Triple-Test-Gate.
    // DUPLICATE DETECTED: Deduplicated hybrid_search to satisfy compiler.
