...
impl MemFuse {
    ...
    /// Returns a collection by name. Creates it if it doesn't exist.
    ...
    // ANCHOR:TODO:COL-002 — Erweitere `list_collections` so, dass es aus dem LSM-Store/Metadata liest.
    ...
    /// Drops a collection and deletes all its data.
