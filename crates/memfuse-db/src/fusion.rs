...
pub fn build_provenance(
    ...
    // DONE(memfuse-impl): Allow rrf_k >= 0.0 since 1-based rank prevents zero division [ref:eigenbau-rrf-fusion]
    debug_assert!(
        rrf_k >= 0.0,
        "rrf_k must be non-negative; division by zero risk avoided by 1-based rank"
    );
