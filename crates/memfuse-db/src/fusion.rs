...
// AI-TAG[SMELL][MINOR] TODO(audit-NC-6): Validate candidate scores with score.is_finite() before multiplying resonance bonus to prevent NaN score propagation. (TS: 2026-09-10T19:15:16Z) (SESSION: 931776f5)
...
// AI-TAG[SMELL][MINOR] TODO(audit-M-1): Preserve scalar field types when metadata values are identical across sources instead of unconditionally converting scalars to JSON arrays. (TS: 2026-09-10T19:15:16Z) (SESSION: 931776f5)
...
// AI-TAG[SMELL][MINOR] TODO(audit-H-4): Filter out non-positive weight or invalid signals before calculating total_signal_count in RRF rank mass normalization. (TS: 2026-09-10T19:15:16Z) (SESSION: 931776f5)
