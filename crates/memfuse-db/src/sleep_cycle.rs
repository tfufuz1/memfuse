...
///
/// AI-TAG[DEBT][LOW] Falls `DocId` in zukünftigen Speichermodellen nicht streng monoton mit der Erstellungszeit korreliert, sollte diese Funktion `TxId` oder explizite Timestamps als Parameter anstelle von `DocId` akzeptieren. (TS:2026-09-07T06:40:00Z) (SESSION: e3455d66)
///
