//! LSM-Snapshots and Checkpointing Manager.
//!
...
/// Represents a persistent snapshot of the database at a specific point in time.
pub struct Checkpoint {
    pub name: String,
    pub seq_no: u64,
}

/// Manages database checkpoints for time-travel and data safety.
