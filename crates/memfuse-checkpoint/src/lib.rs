...
mod tests {
    ...
    async fn test_list_checkpoints_ordered() {
        ...
        let list = manager.list_checkpoints().await.expect("test setup");
    ...
    async fn test_checkpoint_persistence_reload() {
        ...
        let list = manager2.list_checkpoints().await.expect("test setup");
    ...
    async fn test_concurrent_checkpoint_creation() {
        ...
        for handle in handles {
            handle.await.expect("test setup").expect("test setup");
        }

        let list = store.list_checkpoints().await.expect("test setup");
    ...
    fn test_checkpoint_registry_in_memory() {
        ...
        let retrieved = registry.get(tx_id).expect("test setup");
    ...
    async fn test_internal_tx_ids_use_reserved_range() {
        ...
        // Delete one
        store.drop_checkpoint("cp_0").await.expect("test setup");
