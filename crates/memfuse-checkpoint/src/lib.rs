...
mod tests {
    ...
    async fn test_checkpoint_create_and_restore() {
        ...
        let meta = manager
            ...
            .await
            .expect("checkpoint created"); // unwrap
        ...
        let retrieved = manager.get_checkpoint("test_cp").await.expect("retrieved").expect("exists"); // unwrap
    ...
    async fn test_checkpoint_metadata_roundtrip() {
        ...
        manager
            ...
            .await
            .expect("cp1 created"); // unwrap

        let retrieved = manager.get_checkpoint("cp1").await.expect("retrieved").expect("exists"); // unwrap
    ...
    fn test_checkpoint_registry_in_memory() {
        ...
        let retrieved = registry.get(tx_id).expect("retrieved"); // unwrap
