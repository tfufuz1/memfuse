...
mod tests {
    ...
    async fn test_checkpoint_create_and_restore() {
        ...
        let retrieved = manager
            ...
            .await
            .expect("should get") // unwrap
            .expect("should exist"); // unwrap
    ...
    async fn test_list_checkpoints_ordered() {
        ...
        let list = manager.list_checkpoints().await.expect("should list"); // unwrap
    ...
    async fn test_checkpoint_persistence_reload() {
        ...
        let list = manager2.list_checkpoints().await.expect("should list"); // unwrap
    ...
    fn test_checkpoint_registry_in_memory() {
        ...
        let retrieved = registry.get(tx_id).expect("should exist"); // unwrap
