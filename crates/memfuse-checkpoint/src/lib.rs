...
.unwrap() /* unwrap allowed */;
        ...
        let retrieved = manager.get_checkpoint("test_cp").await
.unwrap() /* unwrap allowed */
.unwrap() /* unwrap allowed */;
...
.unwrap() /* unwrap allowed */;
        ...
        let retrieved = manager.get_checkpoint("cp1").await
.unwrap() /* unwrap allowed */
.unwrap() /* unwrap allowed */;
...
.unwrap() /* unwrap allowed */;
        ...
        let list = manager2.list_checkpoints().await
.unwrap() /* unwrap allowed */;
    ...
    fn test_checkpoint_registry_in_memory() {
        ...
        let retrieved = registry.get(tx_id)
.unwrap() /* unwrap allowed */;
