...
mod tests {
    ...
    async fn test_checkpoint_create_and_restore() {
        ...
        let retrieved = manager
            ...
            .await
            .expect("get checkpoint failed") // unwrap
            .expect("not found"); // unwrap
    ...
    async fn test_list_checkpoints_ordered() {
        ...
        manager
            ...
            .await
            .expect("create cp2 failed"); // unwrap
        manager
            .create_checkpoint("cp1", "c1", 10, serde_json::json!({}))
            .await
            .expect("create cp1 failed"); // unwrap
        manager
            .create_checkpoint("cp3", "c1", 30, serde_json::json!({}))
            .await
            .expect("create cp3 failed"); // unwrap
    ...
    fn test_checkpoint_registry_in_memory() {
        ...
        let retrieved = registry.get(tx_id).expect("not found"); // unwrap
