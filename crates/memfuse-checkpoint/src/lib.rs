...
mod tests {
    ...
    async fn test_checkpoint_create_and_restore() {
        ...
        let retrieved = manager.get_checkpoint("test_cp").await.expect("get ok").expect("found"); // unwrap
    ...
    async fn test_checkpoint_metadata_roundtrip() {
        ...
        let retrieved = manager.get_checkpoint("cp1").await.expect("get ok").expect("found"); // unwrap
    ...
    async fn test_list_checkpoints_ordered() {
        ...
        let list = manager.list_checkpoints().await.expect("list ok"); // unwrap
    ...
    async fn test_checkpoint_persistence_reload() {
        ...
        let list = manager2.list_checkpoints().await.expect("list ok"); // unwrap
