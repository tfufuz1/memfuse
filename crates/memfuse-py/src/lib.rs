...
/// Python facade for the MemFuse database.
...
impl PyMemFuse {
    ...
    /// Performs semantic search in the default collection.
    ...
    /// Scans documents by prefix in the default collection.
    ...
    /// Scans a range of documents in the default collection.
...
/// Python representation of a MemFuse collection.
