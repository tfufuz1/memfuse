...
impl ResourceTracker {
    ...
    /// Consumes the specified amount of memory from the budget.
    ///
    /// Returns `Err(MemFuseError::MemoryBudgetExceeded)` if the limit would be exceeded.
    ...
    /// Returns a reference to the resource budget configuration.
