...
impl DocId {
    ...
    pub fn from_key(key: &str) -> Self {
        // ANCHOR:DEBT:TYPES-003 AGENT:13 STATUS:DONE PRIO:3
        // SAFETY: blake3::hash() always returns a 32-byte hash. Direct slicing is safe.
...
impl ResourceTracker {
    ...
    pub fn consume_memory(&self, bytes: u64) -> Result<()> {
        // ANCHOR:DEBT:TYPES-004 AGENT:01 STATUS:DONE PRIO:2
        // Hardening ResourceTracker using fetch_update to prevent underflow and atomic budget check.
        self.memory_used
            .fetch_update(
