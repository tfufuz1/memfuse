...
// ANCHOR:ARCH:GATE-FV STATUS:OPEN AGENT:00 DATE:2026-06-21
// WATCHDOG: Blocking merges due to missing Kani/TLA+ proofs for REVIEW components (WAL/LSM/Encryption).
