...
// WATCHDOG: Blocking merges due to missing Kani/TLA+ proofs for REVIEW components (WAL/LSM) AND critical CI build failures in integration tests (WP-3.2 regression).
