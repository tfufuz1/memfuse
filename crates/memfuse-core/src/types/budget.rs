...
//!
//! Provides mechanisms for monitoring memory consumption and applying
//! backpressure to prevent system exhaustion under heavy load.

// ANCHOR:DOC:BUDGET-001
