...
//!
//! Provides the `ResourceTracker` for monitoring and enforcing memory limits
//! across the system, supporting backpressure and capacity checks.

// ANCHOR:DOC:BUDGET-001 — Module-level documentation for budget.rs.
// AGENT:01 STATUS:DONE PRIO:3
// ANCHOR:DEBT:BUDGET-002 — Unannotated unwrap/expect in tests.
// AGENT:01 STATUS:DONE PRIO:3
