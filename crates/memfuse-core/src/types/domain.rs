...
mod tests {
    ...
    // REVIEW-PASS[1/2] STATUS:PASS (ID: TEST:CORE-001) (TS: 2026-08-31T22:30:00Z) (SESSION: b8e4f1a2)
    // REVIEW-PASS[2/2] STATUS:PASS (ID: TEST:CORE-001) (TS: 2026-08-31T22:31:00Z) (SESSION: c9f5e2b3)
