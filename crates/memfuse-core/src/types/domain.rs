...
mod tests {
    ...
    // REVIEW-PASS[1/2] STATUS:PASS (ID: TEST:CORE-001) (TS:2026-08-30T21:51:46Z) (SESSION: b8e4f1a2)
    // REVIEW-PASS[2/2] STATUS:PASS (ID: TEST:CORE-001) (TS:2026-08-30T22:00:00Z) (SESSION: c9f5e2b3)
