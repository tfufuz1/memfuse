...
// ANCHOR:FIXME:WP-5.3-REGRESSION STATUS:TODO PRIO:1 AGENT:00 DATE:2026-05-22
// FIXME: Duplicate StateGraph definition and missing methods in lib.rs cause compilation failures in integration tests.
