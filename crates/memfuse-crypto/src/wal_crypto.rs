...
mod tests {
    ...
    fn test_wal_hmac_basic() {
        ...
        let mut hmac = WalHmac::new(key).unwrap(); // expect #[cfg(test)]
        hmac.update(b"data");
    ...
    fn test_integrity_verifier_chain() {
        ...
        // entry 1
        let mut hmac1 = WalHmac::new(key).unwrap(); // expect #[cfg(test)]
        ...
        // entry 2
        let mut hmac2 = WalHmac::new(key).unwrap(); // expect #[cfg(test)]
