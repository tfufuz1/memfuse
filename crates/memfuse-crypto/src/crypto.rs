...
mod tests {
    ...
    // REVIEW-PASS[1/2] STATUS:PASS (ID: TEST:CRY-001) (TS:2026-08-30T18:54:39Z) (SESSION: b8e4f1a2)
    // REVIEW-PASS[2/2] STATUS:PASS (ID: TEST:CRY-001) (TS:2026-08-30T19:00:00Z) (SESSION: c9f5e2b3)
    #[tokio::test]
