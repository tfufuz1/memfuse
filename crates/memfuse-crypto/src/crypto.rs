...
impl KeyManager {
    ...
    // AI-TAG[SMELL][MINOR] AI-TAG[SMELL][MINOR] TODO(audit-5.2): (TS:2026-09-10T20:03:54Z) (SESSION:345864c8) Use length-prefixed canonical encoding for HKDF info string parameters in derive_kv_key to prevent string key collisions.
