...
impl RouterEngine {
    ...
    /// Records the outcome of a routing decision for online conformal calibration.
    ///
    /// Returns `true` if the decision ID was found and outcome recorded, `false` otherwise.
