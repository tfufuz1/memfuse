#![allow(unsafe_code)]
// ANCHOR:DEBT:WP-0.0-ZEROPANIC — Eradicate .expect("security audit: documented safety") in persistence.rs
// WP:WP-0.0 PRIO:1 NEEDS:NONE
// AGENT:@JULES-13 DATE:2026-05-27 STATUS:READY
// TEST: grep -c ".expect("security audit: documented safety")" crates/memfuse-index/src/persistence.rs
// DONE: Alle .expect("security audit: documented safety") Aufrufe auf try_into() sind durch ? ersetzt.
