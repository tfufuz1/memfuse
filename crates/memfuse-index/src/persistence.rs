    ...
    pub fn try_from_bytes(bytes: &[u8]) -> Result<Self> {
        ...
        Ok(Self {
            ...
            connections_offset: u64::from_le_bytes(
                bytes[48..56].try_into().unwrap(), /* unwrap */
            ),
...
impl NodeRecord {
    ...
    pub fn from_bytes(bytes: &[u8]) -> Self {
        Self {
            ...
            connections_offset: u64::from_le_bytes(
                bytes[17..25].try_into().unwrap(), /* unwrap */
            ),
        }
    }
    ...
    pub fn get_connections(&self, record: &NodeRecord, layer: usize) -> Vec<u32> {
        ...
        for _ in 0..layer {
            let len = u32::from_le_bytes(
                self.mmap[current_pos..current_pos + 4].try_into().unwrap(), /* unwrap */
            ) as usize;
            current_pos += 4 + len * 4;
        }
        ...
        for i in 0..len {
            let val = u32::from_le_bytes(
                raw[i * 4..(i + 1) * 4].try_into().unwrap(), /* unwrap */
            );
