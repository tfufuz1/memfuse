...
/// A collection of standard English and German stopwords.
const STOPWORDS: &[&str] = &[
    // English
    ...
    "than", "too", "very", "s", "t", "can", "will", "just", "don", "should", "now", // German
    ...
    "die", "das", "daß", "derselbe", "derselben", "denselben", "derselben", "dieselbe", "dieselben",
    "dasselbe", "dazu", "dein", "deine", "deinem", "deinen", "deiner", "deines", "denn", "derer",
    "dessen", "dich", "dir", "du", "dies", "diese", "diesem", "diesen", "dieser", "dieses", "doch",
    "dort", "durch", "ein", "eine", "einem", "einen", "einer", "eines", "einig", "einige", "einigem",
    "einigen", "einiger", "einiges", "einmal", "er", "ihn", "ihm", "es", "etwas", "euer", "eure",
    ...
    "sein", "seine", "seinem", "seinen", "seiner", "seines", "selbst", "sich", "sie", "ihnen",
    "sind", "so", "solche", "solchem", "solchen", "solcher", "solches", "soll", "sollte", "sondern",
    "sonst", "über", "um", "und", "uns", "unsere", "unserem", "unseren", "unser", "unseres", "unter",
...
static STOPWORDS_SET: OnceLock<HashSet<&'static str>> = OnceLock::new();

/// Tokenizes text into lowercase words using Unicode word boundaries, filtering out stopwords.
pub fn tokenize(text: &str) -> Vec<String> {
    let stopwords = STOPWORDS_SET.get_or_init(|| STOPWORDS.iter().cloned().collect());
    text.unicode_words()
...
mod tests {
    ...
    fn test_tokenizer_handles_unicode() {
        ...
        assert!(tokens.contains(&"ölpreise".to_string()));
    ...
    #[test]
    fn test_tokenizer_filters_german_stopwords() {
