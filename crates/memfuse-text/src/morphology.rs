...
mod tests {
    ...
    // REVIEW-PASS[1/2] STATUS:PASS (ID: TEST:TXT-001) (TS: 2026-08-31T21:13:26Z) (SESSION: a1b2c3d4)
    // REVIEW-PASS[2/2] STATUS:PASS (ID: TEST:TXT-001) (TS: 2026-08-31T22:30:00Z) (SESSION: 0dcb9f3b)
    #[test]
