...
async fn test_single_entry_no_commit_marker_replay() -> Result<()> {
    ...
    // AI-TAG[SMELL] audit-M-9 (TS: 2026-09-11T22:52:04Z) (SESSION: 5afeaf78): WAL replay treats all valid WalEntry payloads on disk as implicitly committed unless corrupted.
...
async fn test_disk_full_mid_append_batch_rollback() -> Result<()> {
    ...
    // AI-TAG[SMELL] audit-M-10 (TS: 2026-09-11T22:52:04Z) (SESSION: 5afeaf78): Restoring last HMAC manually after failed batch append ensures in-memory HMAC continuity.
