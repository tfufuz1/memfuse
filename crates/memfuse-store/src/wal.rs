...
pub struct WalConfig {
    ...
    // AI-TAG[SMELL][MINOR] TODO(audit-M-8): Reject unencrypted V1 plaintext entries during replay when KeyManager is present and active. (TS: 2026-09-10T19:15:16Z) (SESSION: 931776f5)
...
impl Wal {
    ...
    // AI-TAG[SMELL][MINOR] TODO(audit-C-3): Atomically check file header/size under file lock before writing header in append_batch to prevent double WAL headers. (TS: 2026-09-10T19:15:16Z) (SESSION: 931776f5)
    ...
    // AI-TAG[SMELL][MINOR] TODO(audit-H-6): Implement post-crash recovery to restore .v1.bak / .v2.bak backup files if primary WAL is corrupted or truncated during rewrite. (TS: 2026-09-10T19:15:16Z) (SESSION: 931776f5)
    ...
    // AI-TAG[SMELL][MINOR] TODO(audit-C-2): Call file.sync_all() immediately after file.set_len() to ensure length truncation is crash-persisted. (TS: 2026-09-10T19:15:16Z) (SESSION: 931776f5)
    ...
    // AI-TAG[SMELL][MINOR] TODO(audit-M-2): Optimize transaction offset search from O(N) sequential replay scan to index lookup or reverse offset scanning. (TS: 2026-09-10T19:15:16Z) (SESSION: 931776f5)
