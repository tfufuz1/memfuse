...
//!
//! ## Performance
//! - **LATENCY-001**: The `sync_all()` call in the write path is a primary source of latency.
//!   Future improvements like Group Commit or offloading fsync to a background thread are recommended
//!   to maintain throughput under high load.
