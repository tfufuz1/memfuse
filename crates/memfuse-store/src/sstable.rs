...
mod tests {
    ...
    async fn test_sstable_bloom_integration() {
        ...
        builder.add(b"key1", b"val1", 1).await.expect("add key1"); // expect
        builder.add(b"key2", b"val2", 2).await.expect("add key2"); // expect
    ...
    async fn test_sstable_scan_prefix() {
        ...
        let mut builder = SstableBuilder::create(&path).await.expect("create builder"); // expect
        builder.add(b"apple/1", b"a1", 1).await.expect("add"); // expect
        builder.add(b"apple/2", b"a2", 2).await.expect("add"); // expect
        builder.add(b"banana/1", b"b1", 3).await.expect("add"); // expect
        builder.add(b"cherry/1", b"c1", 4).await.expect("add"); // expect
        builder.finish().await.expect("finish"); // expect
    ...
    async fn test_sstable_scan_range() {
        ...
        let mut builder = SstableBuilder::create(&path).await.expect("create builder"); // expect
        builder.add(b"a", b"1", 1).await.expect("add"); // expect
        builder.add(b"b", b"2", 2).await.expect("add"); // expect
        builder.add(b"c", b"3", 3).await.expect("add"); // expect
        builder.add(b"d", b"4", 4).await.expect("add"); // expect
        builder.finish().await.expect("finish"); // expect
