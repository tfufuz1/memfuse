...
impl BlockBuilder {
    ...
    /// Adds a key-value pair with sequence number to the SSTable.
    /// Returns true if the block was flushed to disk.
...
impl SstableBuilder {
    ...
    /// Finishes building the SSTable and writes it to disk.
...
impl SstableReader {
    ...
    /// Returns the metadata of the SSTable.
