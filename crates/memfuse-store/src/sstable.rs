...
impl SstableReader {
    ...
    // AKTUELL: Zero-Copy via Bytes aus dem BlockCache
    // BOTTLENECK: Reduziert durch Vermeidung von Vec-Allokationen
    // OPTIMIERUNGSIDEE: SmallVec oder Pool-Buffer (Done: Bytes-Sharing implementiert)
