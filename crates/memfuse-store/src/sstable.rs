...
impl BloomFilter {
    ...
    pub fn from_bytes(data: &[u8]) -> Result<Self> {
        ...
        let num_hashes =
            u64::from_le_bytes(data[0..8].try_into().expect("u64 convert failed")) as usize;
        let num_bits =
            u64::from_le_bytes(data[8..16].try_into().expect("u64 convert failed")) as usize;
