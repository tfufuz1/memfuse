...
impl LsmStorage {
    ...
    async fn rollback_to_tx_locked(&self, target_tx: TxId, _guard: &CommitGuard<'_>) -> Result<()> {
        // AI-TAG[SMELL][MINOR] Write crash-atomic rollback intent file before any mutation. Recovery implemented in startup. (ID: AGT-STORE-27a11909) (TS: 2026-09-11T00:22:00Z) (SESSION: 2c1d14ab)
