...
"#,
    ...
    fn test_check_review_coverage_fixtures() {
        ...
        // Fixture 4: Unsafe file requires 3 REVIEW-PASS entries
        let unsafe_anchor = vec![TagItem {
            file_path: "crates/memfuse-index/src/distance.rs".to_string(),
            line_num: 10,
            tag_type: "ANCHOR".to_string(),
            raw: "// ANCHOR[DEBT:IND-001] STATUS:DONE (ID: AGT-INDEX-a3f29c1d) (TS:2026-08-29T09:14:07Z) (SESSION:a3f29c1d)".to_string(),
            timestamp: "2026-08-29T09:14:07Z".to_string(),
            category: None,
            severity: None,
        ...
        let mut unsafe_2_passes = unsafe_anchor.clone();
        unsafe_2_passes.push(TagItem {
            file_path: "crates/memfuse-index/src/distance.rs".to_string(),
            line_num: 15,
            tag_type: "REVIEW-PASS".to_string(),
        ...
        // 2 passes for unsafe file should FAIL
        assert!(!run_check_review_coverage(&unsafe_2_passes));

        let mut unsafe_3_passes = unsafe_2_passes.clone();
        unsafe_3_passes.push(TagItem {
            file_path: "crates/memfuse-index/src/distance.rs".to_string(),
            line_num: 17,
            tag_type: "REVIEW-PASS".to_string(),
        ...
        // 3 passes for unsafe file should PASS
        assert!(run_check_review_coverage(&unsafe_3_passes));
    }
