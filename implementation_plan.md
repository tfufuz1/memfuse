...
| **W-06** | **CRIT-001 unresolved: `DocId::from_key()` uses `.expect()`** | `memfuse-core` (documented in AGENTS.md audit findings) | Known since 2026-05-20, still unfixed. |
...
| **2b** | Fix CRIT-001: `DocId::from_key()` `.expect()` → `?` propagation | `memfuse-core` | 5 LoC |
