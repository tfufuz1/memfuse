...
|-------|-------|
| SESSION | `unknown` |
| LAST_SYNC | `2026-08-29T14:40:14Z` |
...
| `memfuse-store` | L1 | 10095 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-text` | L1 | 3562 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-db` | L2 | 11963 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
...
| `memfuse-py` | L3 | 963 | 🟢 Clean | Python bindings for MemFuse using PyO3 |
| `memfuse-router` | L3 | 510 | 🟢 Clean |  |
| `memfuse-mcp` | L4 | 2095 | 🟢 Clean |  |
| `memfuse-tauri` | L4 | 2609 | 🟢 Clean |  |
