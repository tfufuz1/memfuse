...
| `crates/memfuse-db/src/context_compaction.rs` | 107 | `AGT-DB-004` | `SMELL` | `MINOR` | `2026-08-25T00:00:00Z` | // AI-TAG[SMELL][MINOR] Async LLM-Summarization for context compaction (ID: AGT-DB-004) (TS:2026-08-25T00:00:00Z) |
...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core` | 0 | 6.147 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-db` | 2 | 9.638 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
