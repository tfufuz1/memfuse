...
|-------|-------|
| SESSION | `unknown` |
| LAST_SYNC | `2026-08-30T16:35:13Z` |
...
| `memfuse-store` | L1 | 10135 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-text` | L1 | 3830 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-db` | L2 | 12739 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
