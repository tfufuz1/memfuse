...
- Letzter Merge: 656beb6 — "Shell-Commit" (unbekannt)
...
Layer 6:  memfuse-mcp —  (deps: memfuse-agent, memfuse-candle, memfuse-core, memfuse-db, memfuse-embed, memfuse-ollama, memfuse-security)
```
