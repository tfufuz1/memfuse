...
|---|---|---|---|---|---|---|
| `crates/memfuse-db/src/collection/query_builder.rs` | 249 | `AGT-DB-2f1b6962` | `SEARCH` | `MAJOR` | `2026-09-04T12:59:04Z` | // AI-TAG[SEARCH][MAJOR] QueryBuilder ignores include_superseded from query_config and bypasses hybrid_search_with_query (ID: AGT-DB-2f1b6962) (TS: 2026-09-04T12:59:04Z) (SESSION: d01ee970) |
