...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core` | 0 | 7.6k | 🟢 Clean | Core types, traits, and error handling for MemFuse |
| `memfuse-checkpoint` | 1 | 1.5k | 🟢 Clean | Backup and snapshot management for MemFuse storage |
| `memfuse-crypto` | 1 | 1.4k | 🟢 Clean | Encryption at Rest utilities for MemFuse |
| `memfuse-graph` | 1 | 5.2k | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-index` | 1 | 7.6k | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-store` | 1 | 10.4k | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-text` | 1 | 4.0k | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-db` | 2 | 12.9k | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
| `memfuse-agent` | 3 | 2.9k | 🟢 Clean | Persistent agent workflow engine for MemFuse — checkpoint/execute/audit loop |
| `memfuse-embed` | 3 | 1.1k | 🧊 Optional |  |
| `memfuse-ollama` | 3 | 2.4k | 🟢 Clean |  |
| `memfuse-py` | 3 | 1.2k | 🟢 Clean | Python bindings for MemFuse using PyO3 |
| `memfuse-router` | 3 | 510 | 🟢 Clean |  |
| `memfuse-mcp` | 4 | 2.5k | 🟢 Clean |  |
| `memfuse-tauri` | 4 | 2.6k | 🟢 Clean |  |
