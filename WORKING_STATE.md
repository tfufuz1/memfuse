...
|-------|-------|
| SESSION | `unknown` |
| LAST_SYNC | `2026-08-30T14:46:05Z` |
...
|-------|-------|-----|--------|-------------|
| `memfuse-core` | L0 | 7490 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-graph` | L1 | 5138 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
...
| `memfuse-db` | L2 | 12412 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
