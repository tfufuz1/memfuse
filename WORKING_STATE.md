...
|---|---|---|---|---|---|---|
| `crates/memfuse-router/src/lyapunov.rs` | 151 | `-` | `SMELL` | `MINOR` | `2026-09-10T19:16:25Z` | // AI-TAG[SMELL][MINOR] Increase Laplace smoothing epsilon or add bounds clipping to prevent numerical instability during KL divergence calculations. (TS: 2026-09-10T19:16:25Z) (SESSION: 3f3e4637) |
