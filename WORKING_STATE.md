...
| `crates/memfuse-store/tests/wal_boundary_and_mutation_hardening.rs` | 206 | `-` | `SMELL` | `-` | `` | // AI-TAG[SMELL] audit-M-9: WAL replay treats all valid WalEntry payloads on disk as implicitly committed unless corrupted. |
| `crates/memfuse-store/tests/wal_boundary_and_mutation_hardening.rs` | 365 | `-` | `SMELL` | `-` | `` | // AI-TAG[SMELL] audit-M-10: Restoring last HMAC manually after failed batch append ensures in-memory HMAC continuity. |
