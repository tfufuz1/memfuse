...
|-------|-------|
| SESSION | `unknown` |
| LAST_SYNC | `2026-08-29T17:39:23Z` |
...
|-------|-------|-----|--------|-------------|
| `memfuse-core` | L0 | 7184 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
| `memfuse-checkpoint` | L1 | 1173 | 🟢 Clean | Backup and snapshot management for MemFuse storage |
...
| `memfuse-store` | L1 | 10122 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-text` | L1 | 3575 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-db` | L2 | 11969 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
...
| `memfuse-py` | L3 | 994 | 🟢 Clean | Python bindings for MemFuse using PyO3 |
| `memfuse-router` | L3 | 510 | 🟢 Clean |  |
| `memfuse-mcp` | L4 | 2205 | 🟢 Clean |  |
