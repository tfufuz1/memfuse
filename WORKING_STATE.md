...
| `crates/memfuse-store/src/lsm.rs` | 316 | `AGT-STORE-5a195b0b` | `SMELL` | `MINOR` | `2026-09-10T19:14:58Z` | // AI-TAG[SMELL][MINOR] TODO(audit-NC-5): Enforce strict monotonic sequence IDs in WAL file naming instead of relying solely on sub-second timestamps to prevent wal.log vs wal-0.log collisions. (ID: AGT-STORE-5a195b0b) (TS: 2026-09-10T19:14:58Z) (SESSION: 21a8d3e8) |
| `crates/memfuse-store/src/lsm.rs` | 338 | `AGT-STORE-cbd72ab9` | `SMELL` | `MINOR` | `2026-09-11T10:21:34Z` | // AI-TAG[SMELL][MINOR] Simplify map_or(0, \|m\| m) to unwrap_or(0) to resolve clippy::map_or_identity warning. (ID: AGT-STORE-cbd72ab9) (TS: 2026-09-11T10:21:34Z) (SESSION: 31ada253) |
| `crates/memfuse-store/src/lsm.rs` | 750 | `AGT-STORE-1f3c3709` | `SMELL` | `MINOR` | `2026-09-10T19:14:58Z` | // AI-TAG[SMELL][MINOR] TODO(audit-M-4): Avoid creating a new SSTable when rolling back single-entry or small uncommitted transactions. (ID: AGT-STORE-1f3c3709) (TS: 2026-09-10T19:14:58Z) (SESSION: 21a8d3e8) |
| `crates/memfuse-store/src/lsm.rs` | 4065 | `AGT-STORE-1e73ead8` | `FLAKY` | `MINOR` | `2026-09-11T10:21:34Z` | // AI-TAG[FLAKY][MINOR] 5ms threshold in test_concurrent_get_and_flush_latency is susceptible to thread contention under parallel test runs (--test-threads=8). Consider relaxing latency bound to 20ms or using adaptive threshold. (ID: AGT-STORE-1e73ead8) (TS: 2026-09-11T10:21:34Z) (SESSION: 31ada253) |
...
| `crates/memfuse-store/tests/wal_boundary_and_mutation_hardening.rs` | 213 | `AGT-STORE-6eadc4f2` | `SMELL` | `MINOR` | `2026-09-11T23:00:00Z` | // AI-TAG[SMELL][MINOR] audit-M-9: WAL replay treats all valid WalEntry payloads on disk as implicitly committed unless corrupted. (ID: AGT-STORE-6eadc4f2) (TS: 2026-09-11T23:00:00Z) (SESSION: b4480840) |
| `crates/memfuse-store/tests/wal_boundary_and_mutation_hardening.rs` | 372 | `AGT-STORE-e9a8ee22` | `SMELL` | `MINOR` | `2026-09-11T23:00:00Z` | // AI-TAG[SMELL][MINOR] audit-M-10: Restoring last HMAC manually after failed batch append ensures in-memory HMAC continuity. (ID: AGT-STORE-e9a8ee22) (TS: 2026-09-11T23:00:00Z) (SESSION: b4480840) |
