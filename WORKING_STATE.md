...
|---|---|---|---|---|---|---|
| `crates/memfuse-checkpoint/src/lib.rs` | 1370 | `AGT-CHECKPOINT-a3ccc9fe` | `TEST` | `MAJOR` | `2026-09-03T19:40:20Z` | // AI-TAG[TEST][MAJOR] Parallel unit test race condition on global_orphan_registry OnceLock singleton (ID: AGT-CHECKPOINT-a3ccc9fe) (TS: 2026-09-03T19:40:20Z) (SESSION: d766fd58) |
