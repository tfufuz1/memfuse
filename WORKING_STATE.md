...
|-------|-------|
| SESSION | `unknown` |
| LAST_SYNC | `2026-08-30T14:40:14Z` |
...
| `memfuse-index` | L1 | 7329 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-store` | L1 | 10333 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-text` | L1 | 3631 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-db` | L2 | 12425 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
