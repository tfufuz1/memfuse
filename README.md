...
# Initialize database & collection (dimension=1536 default)
db = memfuse.open("./data", dimension=1536)
collection = db.collection("documents")

# 1536-dimensional float32 vector (e.g., generated by your embedding model)
