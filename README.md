...
- **Hybrid Search** — Combined BM25 (text) and Vector search via RRF (Reciprocal Rank Fusion) [DONE] [DONE] [DONE]
- **Multi-Tenancy** — Logically isolated collections (namespaces) for different agents/tasks [DONE]
...
- **Hybrid Search** — Optimized BM25 + Vector Fusion (RRF) [DONE]
- **Scalar Quantization** — SQ8 compression for 4x reduced RAM footprint
- **Deterministic Checkpointing** — Native state pinning for "Time-Travel" debugging [DONE]
