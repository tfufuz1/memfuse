...
# Connect to MemFuse (LSM-Tree, HNSW, BM25)
db = memfuse.open("./my_agent_memory")
col = db.collection("agent_context", dimension=1536)

# High-performance Vector & Text Search
v = [0.1] * 1536
col.insert("doc_1", v, metadata={"text": "Rust is safe and fast."})

# Hybrid Search (Vector + BM25)
results = col.hybrid_search("Rust performance", v, k=5)
for res in results:
