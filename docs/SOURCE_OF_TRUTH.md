...
| `memfuse-text` | 1 | 4193 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-db` | 2 | 14822 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
...
| `memfuse-mcp` | 4 | 2838 | 🟢 Clean |  |
| `memfuse-tauri` | 4 | 3494 | 🟢 Clean |  |
