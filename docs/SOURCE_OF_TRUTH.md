...
| `memfuse-graph` | 1 | 10183 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-security` | 1 | 3860 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
...
| `memfuse-store` | 2 | 16125 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 3 | 1893 | 🧊 Optional |  |
| `memfuse-db` | 4 | 27043 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
