...
| `memfuse-graph` | 1 | 5542 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-index` | 1 | 9324 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-store` | 1 | 11386 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
