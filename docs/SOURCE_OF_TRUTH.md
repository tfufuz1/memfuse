...
| `memfuse-index` | 1 | 9502 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-store` | 1 | 11506 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-text` | 1 | 4192 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
