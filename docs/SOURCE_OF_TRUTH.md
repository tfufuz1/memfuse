...
| `memfuse-graph` | 1 | 6169 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-index` | 1 | 10532 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
