...
| `memfuse-graph` | 1 | 5726 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
...
| `memfuse-text` | 1 | 4191 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
