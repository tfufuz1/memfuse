...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core` | 0 | 7769 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
| `memfuse-checkpoint` | 1 | 1643 | 🟢 Clean | Backup and snapshot management for MemFuse storage |
| `memfuse-crypto` | 1 | 1443 | 🟢 Clean | Encryption at Rest utilities for MemFuse |
...
| `memfuse-db` | 2 | 12929 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
