...
| `memfuse-core` | 1 | 9517 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-security` | 2 | 5185 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
| `memfuse-text` | 2 | 5463 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-candle` | 3 | 3447 | 🟢 Clean | Native Candle GGUF ML inference backend for MemFuse |
| `memfuse-index` | 3 | 15863 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 3 | 4233 | 🟢 Clean |  |
| `memfuse-store` | 3 | 20285 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 4 | 2201 | 🧊 Optional |  |
| `memfuse-db` | 5 | 33436 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
