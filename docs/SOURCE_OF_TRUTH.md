...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core` | 0 | 9943 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-security` | 1 | 4435 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
...
| `memfuse-index` | 2 | 15320 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 2 | 3925 | 🟢 Clean |  |
| `memfuse-store` | 2 | 16416 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 3 | 1940 | 🧊 Optional |  |
| `memfuse-db` | 4 | 27613 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
