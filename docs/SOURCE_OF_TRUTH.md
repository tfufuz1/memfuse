...
| `memfuse-core` | Layer 0 | 🟢 Clean | Core types, traits, and error handling for MemFuse
| `memfuse-checkpoint` | Layer 1 | 🟢 Clean | Backup and snapshot management for MemFuse storage
| `memfuse-crypto` | Layer 1 | 🟢 Clean | Encryption at Rest utilities for MemFuse
| `memfuse-graph` | Layer 1 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion)
| `memfuse-index` | Layer 1 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse
| `memfuse-store` | Layer 1 | 🟢 Clean | LSM-Tree storage engine for MemFuse
| `memfuse-text` | Layer 1 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search
| `memfuse-db` | Layer 2 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents
| `memfuse-agent` | Layer 3 | 🟢 Clean | Persistent agent workflow engine for MemFuse — checkpoint/execute/audit loop
| `memfuse-embed` | Layer 3 | 🧊 Optional |
| `memfuse-ollama` | Layer 3 | 🟢 Clean |
| `memfuse-py` | Layer 3 | 🟢 Clean | Python bindings for MemFuse using PyO3
| `memfuse-router` | Layer 3 | 🟢 Clean |
| `memfuse-mcp` | Layer 4 | 🟢 Clean |
| `memfuse-tauri` | Layer 4 | 🟢 Clean |
