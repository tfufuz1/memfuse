...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core` | 0 | 9991 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-security` | 1 | 4644 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
...
| `memfuse-index` | 2 | 15534 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 2 | 3925 | 🟢 Clean |  |
| `memfuse-store` | 2 | 16996 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 3 | 1940 | 🧊 Optional |  |
| `memfuse-db` | 4 | 27863 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
