...
| `memfuse-index` | 1 | 11722 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
...
| `memfuse-db` | 2 | 18454 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
