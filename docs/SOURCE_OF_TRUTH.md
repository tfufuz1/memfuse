...
| `memfuse-graph` | 1 | 8535 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
...
| `memfuse-db` | 3 | 22955 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
