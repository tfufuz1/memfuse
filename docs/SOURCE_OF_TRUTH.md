...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core` | 0 | 8156 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
| `memfuse-checkpoint` | 1 | 1468 | 🟢 Clean | Backup and snapshot management for MemFuse storage |
| `memfuse-crypto` | 1 | 1939 | 🟢 Clean | Encryption at Rest utilities for MemFuse |
| `memfuse-graph` | 1 | 6983 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-index` | 1 | 7932 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-store` | 1 | 10961 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-text` | 1 | 5067 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-db` | 2 | 13758 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
| `memfuse-agent` | 3 | 4495 | 🟢 Clean | Persistent agent workflow engine for MemFuse — checkpoint/execute/audit loop |
| `memfuse-embed` | 3 | 1182 | 🧊 Optional |  |
| `memfuse-ollama` | 3 | 2821 | 🟢 Clean |  |
| `memfuse-py` | 3 | 1298 | 🟢 Clean | Python bindings for MemFuse using PyO3 |
| `memfuse-router` | 3 | 511 | 🟢 Clean |  |
| `memfuse-mcp` | 4 | 2825 | 🟢 Clean |  |
