...
| `memfuse-graph` | 1 | 4.412 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-index` | 1 | 7.265 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
...
| `memfuse-db` | 2 | 10.940 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
