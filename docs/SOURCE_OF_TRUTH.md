...
| `memfuse-graph` | 1 | 5331 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
...
| `memfuse-text` | 1 | 4085 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-db` | 2 | 13269 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
