...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core` | 0 | 7.170 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-index` | 1 | 7.316 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
...
| `memfuse-db` | 2 | 11.943 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
