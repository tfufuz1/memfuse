...
| `memfuse-graph` | 1 | 2.763 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
...
| `memfuse-db` | 2 | 9.294 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
