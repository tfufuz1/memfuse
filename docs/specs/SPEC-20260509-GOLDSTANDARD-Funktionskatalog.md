...
| GS-02 | PLANNING | Declarative StateGraph API | memfuse-saos-agent | WP-5.3 | WP-6.2 |
| GS-03 | PLANNING | Autonomes Kontext-Management | memfuse-db | GS-01 | WP-6.3 |
...
| GS-06 | PLANNING | Air-Gap Deployment Profile | memfuse-py, memfuse-embed | WP-3.1 + WP-3.2 | WP-6.6 |
