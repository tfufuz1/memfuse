...
|----|---------|-------|-------------|-----|--------|
| GS-01 | 4-Signal Fusion API | memfuse-db | WP-2.1 + WP-2.2 | WP-6.1 | Vector/Text/Meta: DONE, Graph: IN_ISOLATION |
| GS-02 | Declarative StateGraph API | memfuse-saos-agent | WP-5.3 | WP-6.2 | PLANNING |
| GS-03 | Autonomes Kontext-Management | memfuse-db | GS-01 | WP-6.3 | PLANNING |
...
| GS-06 | Air-Gap Deployment Profile | memfuse-py, memfuse-embed | WP-3.1 + WP-3.2 | WP-6.6 | PLANNING |
