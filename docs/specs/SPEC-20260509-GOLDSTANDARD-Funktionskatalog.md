...
> **Status:** WIP (GS-01, GS-04, GS-05, GS-07 DONE)
...
| GS-02 | Declarative StateGraph API | memfuse-saos-agent | WP-5.3 | WP-6.2 | ⬜ OPEN |
| GS-03 | Autonomes Kontext-Management | memfuse-db | GS-01 | WP-6.3 | ⬜ OPEN |
...
| GS-06 | Air-Gap Deployment Profile | memfuse-py, memfuse-embed | WP-3.1 + WP-3.2 | WP-6.6 | ⬜ OPEN |
