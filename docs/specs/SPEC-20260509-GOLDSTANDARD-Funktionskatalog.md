...
| GS-02 | Declarative StateGraph API | memfuse-saos-agent | WP-5.3 | WP-6.2 | PLANNED |
| GS-03 | Autonomes Kontext-Management | memfuse-db | GS-01 | WP-6.3 | PLANNED |
...
| GS-06 | Air-Gap Deployment Profile | memfuse-py | WP-3.1 + WP-3.2 | WP-6.6 | PLANNED |
